...
namespace Sms.Protocol.Cmpp2
{
    ...
    public struct CmppSubmitResp : IMessage
    {
        #region 消息体
        /// <summary>
        ...
        public void FromBytes(byte[] body)
        {
            ...
            //var MsgId1 = Convert.ToUInt64(body, CmppConstants.HeaderSize + 0);
            Result = body[CmppConstants.HeaderSize + 8];
        }

		public CmppSubmitResp FromBytes0(byte[] array)
		{
            FromBytes(array);
            return this;
        }
		...
		public override string ToString()
        {
            return $"{{{nameof(MsgId)}={MsgId}, {nameof(Result)}={Result}}}";
        }
    }
}
